...
w.imageCrop = imageCrop;
	...
	function createUI(container) {
		...
		var formats = "";
		var aFormats = (config && config.formats) || [{title:"Jpeg image", value:"jpg80"}];
	...
	*/
	...
	function CropAndResize(src, recorteActivo, ancho, alto, callback)
	{
		$div.find(".acciones").hide();
...
*/
		pica.resizeCanvas(cropCanvas, resizedCanvas, 3, function (err) {
